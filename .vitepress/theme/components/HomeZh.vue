...
<template>
  <section id="hero">
    ...
    <p class="actions">
      ...
      <a class="setup" href="https://github.com/gojue/ecapture/releases" target="_blank">下载  <img src="https://img.shields.io/github/v/release/gojue/ecapture?display_name=tag&include_prereleases&sort=semver" alt="eCapture Version"/> </a>
    </p>
  </section>
