...
const VIDEO_SOURCE = 'https://player.bilibili.com/player.html?isOutside=true&aid=115819514238165&bvid=BV1gcvQB7E8b&cid=35123495954&p=1'
...
<template>
  ...
  >
    <svg
      ...
      fill="#FFFFFF"
    >
      <title id="simpleicons-play-icon" lang="en">观看eCapture旁观者使用演示</title>
      <path
