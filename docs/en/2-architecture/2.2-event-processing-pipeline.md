...
**Sources:** [pkg/event_processor/processor.go:30-63](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L30-L63), [pkg/event_processor/processor.go:66-89](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L66-L89), [pkg/event_processor/iworker.go:70-89](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L70-L89), [pkg/event_processor/iworker.go:262-306](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L262-L306), [pkg/event_processor/iparser.go:85-115](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iparser.go#L85-L115)
...
**Sources:** [pkg/event_processor/processor.go:30-50](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L30-L50)
...
**Sources:** [pkg/event_processor/processor.go:91-109](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L91-L109)
...
**Sources:** [pkg/event_processor/processor.go:130-155](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L130-L155)
...
**Sources:** [pkg/event_processor/iworker.go:57-63](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L57-L63), [pkg/event_processor/iworker.go:100-123](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L100-L123)
...
**Sources:** [pkg/event_processor/iworker.go:70-89](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L70-L89)
...
- **Ticker interval**: `100ms` per tick ([pkg/event_processor/iworker.go:126](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L126))
- **Timeout threshold**: `MaxTickerCount = 10` ticks = 1 second idle ([pkg/event_processor/iworker.go:52](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L52))
- **Ticker restart**: Socket workers recreate ticker after `drainAndClose()` to avoid stale ticker channel ([pkg/event_processor/iworker.go:293-296](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L293-L296))

**Lifecycle state determination:**
- UUID format parsed in `uuidParse()` ([pkg/event_processor/iworker.go:100-123](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L100-L123))
...
**Sources:** [pkg/event_processor/iworker.go:230-245](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L230-L245)
...
**Sources:** [pkg/event_processor/iworker.go:175-228](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L175-L228)
...
**Sources:** [pkg/event_processor/iworker.go:308-337](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L308-L337)
...
**Sources:** [pkg/event_processor/iparser.go:62-73](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iparser.go#L62-L73), [pkg/event_processor/http_request.go:159-163](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L159-L163), [pkg/event_processor/http_response.go:177-181](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_response.go#L177-L181)
...
- `HTTPRequest.detect()`: Calls `http.ReadRequest()` ([pkg/event_processor/http_request.go:83-92](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L83-L92))
- `HTTPResponse.detect()`: Calls `http.ReadResponse()` ([pkg/event_processor/http_response.go:94-102](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_response.go#L94-L102))
- `DefaultParser.detect()`: Always returns `nil` (matches everything) ([pkg/event_processor/iparser.go:136-138](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iparser.go#L136-L138))

**Sources:** [pkg/event_processor/iparser.go:85-115](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iparser.go#L85-L115), [pkg/event_processor/iparser.go:136-138](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iparser.go#L136-L138)
...
**Sources:** [pkg/event_processor/http_request.go:28-35](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L28-L35)
...
Success indicates valid HTTP/1.1 request format. **Sources:** [pkg/event_processor/http_request.go:83-92](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L83-L92)

**Processing Lifecycle**

| Stage | Method | Operation | Key Lines |
|-------|--------|-----------|-----------|
| Initialization | `Init()` | Create `bytes.Buffer` and `bufio.Reader` | [pkg/event_processor/http_request.go:37-40](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L37-L40) |
| First Write | `Write(b)` (isInit=false) | Write to buffer, call `http.ReadRequest()`, store result, set `isInit=true` | [pkg/event_processor/http_request.go:56-67](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L56-L67) |
| Subsequent Writes | `Write(b)` (isInit=true) | Append additional body data to buffer | [pkg/event_processor/http_request.go:71-78](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L71-L78) |
| Output | `Display()` | Read body, decompress gzip if present, call `httputil.DumpRequest(false)` | [pkg/event_processor/http_request.go:105-157](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L105-L157) |
| Cleanup | `Reset()` | Set `isDone=false`, `isInit=false`, reset buffers | [pkg/event_processor/http_request.go:98-103](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L98-L103) |
...
**Sources:** [pkg/event_processor/http_request.go:123-142](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L123-L142)

**HTTP/2.0 Detection**

If `hr.request.Proto == "HTTP/2.0"`, returns raw bytes without processing. HTTP/2 requires specialized frame handling. **Sources:** [pkg/event_processor/http_request.go:106-108](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/http_request.go#L106-L108)
...
**Sources:** Referenced in [pkg/event_processor/iparser.go:96-99](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iparser.go#L96-L99)
...
**Sources:** [user/event/ievent.go:26-52](https://github.com/gojue/ecapture/blob/ca085d05/user/event/ievent.go#L26-L52)
...
**Sources:** [user/event/ievent.go:26-37](https://github.com/gojue/ecapture/blob/ca085d05/user/event/ievent.go#L26-L37), [user/event/event_openssl.go:77-92](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_openssl.go#L77-L92), [user/event/event_bash.go:37-47](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_bash.go#L37-L47), [user/event/event_masterkey.go:37-55](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_masterkey.go#L37-L55)
...
**Sources:** [user/event/event_openssl.go:77-92](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_openssl.go#L77-L92), [user/event/event_openssl.go:138-141](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_openssl.go#L138-L141)
...
**Sources:** [user/event/event_openssl.go:272-310](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_openssl.go#L272-L310)
...
**Sources:** [pkg/event_processor/iworker.go:198-227](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L198-L227), [user/event/event_openssl.go:237-266](https://github.com/gojue/ecapture/blob/ca085d05/user/event/event_openssl.go#L237-L266)
...
**Sources:** [user/event/ievent.go:54-70](https://github.com/gojue/ecapture/blob/ca085d05/user/event/ievent.go#L54-L70)
...
**Sources:** [pkg/event_processor/processor.go:25-28](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L25-L28), [pkg/event_processor/iworker.go:51-54](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L51-L54)
...
**Sources:** [pkg/event_processor/processor.go:165-175](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L165-L175)
...
Returns `ErrEventWorkerOutcomingFull` when processor output queue is full (capacity: 1024). **Sources:** [pkg/event_processor/iworker.go:164-172](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L164-L172), [pkg/event_processor/iworker.go:67](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L67)
...
**Sources:** [pkg/event_processor/iworker.go:236-242](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L236-L242)
...
**Sources:** [pkg/event_processor/processor.go:130-161](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/processor.go#L130-L161)
...
**Sources:** [pkg/event_processor/iworker.go:346-360](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L346-L360), [pkg/event_processor/iworker.go:308-337](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L308-L337)
...
**Sources:** [pkg/event_processor/iworker.go:86-88](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L86-L88), [pkg/event_processor/iworker.go:142-148](https://github.com/gojue/ecapture/blob/ca085d05/pkg/event_processor/iworker.go#L142-L148)
